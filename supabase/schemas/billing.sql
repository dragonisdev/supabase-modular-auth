-- Desired state for Stripe customer mapping and append-only credit entitlements.
...
-- Browser roles receive no billing privileges. Only the backend service role can
-- manage the customer mapping or read and append entitlement entries.
